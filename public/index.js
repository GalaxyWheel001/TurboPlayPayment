...
function initPreloader() {
    ...
    const triggerReveal = () => requestAnimationFrame(reveal);

    if (document.readyState === 'complete' || document.readyState === 'interactive') {
        triggerReveal();
    } else {
        document.addEventListener('DOMContentLoaded', triggerReveal, { once: true });
    }

    // Fallback for slow mobile connections to avoid the preloader getting stuck
